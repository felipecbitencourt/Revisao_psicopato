...
(function () {
  ...
  var CASOS = [
    {
      id:'panico', cat:'Transtornos de ansiedade', nivel:'N2',
      ...
      vinheta:[
        'Mulher de 27 anos, analista administrativa, encaminhada após atendimento em pronto-socorro por suspeita de infarto. O primeiro episódio ocorreu em 26/02, de início abrupto, com taquicardia, dispneia, sudorese, parestesias nas mãos e sensação de irrealidade, atingindo intensidade máxima por volta de dez minutos e cedendo ao longo da hora seguinte. O eletrocardiograma e a troponina seriada foram normais e recebeu alta. Desde então repetem-se episódios semelhantes, sem situação ou local que os precipite, com recorrência aproximadamente quinzenal até o momento.',
        'Nega uso de álcool, drogas ou medicações contínuas e, por iniciativa própria, suspendeu o café desde 24/03; o marido informa que, nos dias sem episódios, ela mantém o ritmo e o nível de atividade de sempre. Permanece em alerta no intervalo entre as crises, verificando o próprio pulso ao longo do dia e antecipando a próxima, e passou a deslocar-se ao trabalho apenas acompanhada, tendo interrompido a academia e o curso de espanhol. Nos dias em que não tem crise mantém o humor estável e segue obtendo prazer no convívio com a família; reconhece o caráter desproporcional do medo.'
      ],
      pergunta:'Dentre as alternativas, qual o diagnóstico mais provável?',
      opts:['Transtorno Depressivo Maior','Transtorno de Ansiedade Generalizada','Transtorno de Pânico','Transtorno Bipolar Tipo II'],
      correct:2,
      explicacao:'Ataques recorrentes e inesperados (sem gatilho), com pico em poucos minutos, seguidos de preocupação persistente e mudança de comportamento entre as crises (monitorar o pulso, sair só acompanhada, abandonar atividades), definem o Transtorno de Pânico (DSM-5-TR). A apreensão é paroxística e ligada às crises, não difusa e de fundo, o que afasta a Ansiedade Generalizada; humor e prazer preservados nos dias sem crise afastam a Depressão; e o nível de atividade habitual descrito pelo marido, sem períodos de energia elevada, afasta o Bipolar Tipo II.'
    },
    {
      id:'depressao', cat:'Transtornos depressivos', nivel:'N2',
      ...
      vinheta:[
        'Homem de 34 anos, contador, casado, trazido pela esposa. A partir do início de abril deixou de comparecer à corrida de domingo e ao churrasco mensal com os colegas, programas que antes aguardava, e desde então apresenta humor rebaixado na maior parte do dia, quase diariamente. Acorda por volta das 4h30 e não retoma o sono, perdeu cerca de 5 kg em dois meses sem mudança alimentar, passou a reler os mesmos balancetes várias vezes e a cometer erros de conferência em tarefas que dominava. Relata ideação passiva (“às vezes penso que seria melhor sumir”), sem plano nem intenção, com crítica preservada; nega uso de substâncias e os exames recentes de TSH e função hepática são normais.',
        'Houve um a dois períodos semelhantes em anos anteriores, com retorno ao funcionamento laboral e familiar pleno entre eles, e o registro ao longo da vida traz apenas rebaixamentos do humor; a esposa situa o atual como o mais intenso. Na avaliação, cerca de dois meses após o início, mostra-se colaborativo, com lentificação psicomotora evidente, latência de resposta aumentada e fala em tom baixo e monossilábica, afeto rebaixado e congruente. Refere preocupação com contas e com o emprego, que situa como decorrência do estado atual e não como traço antigo; orientação, memória e atenção estão preservadas a despeito da queixa de lentidão.'
      ],
      pergunta:'Dentre as alternativas, qual o diagnóstico mais provável?',
      ...
      correct:1,
      explicacao:'Humor rebaixado e perda de interesse na maior parte do dia, por mais de duas semanas (início em abril, avaliação cerca de dois meses depois), com despertar precoce, perda ponderal sem dieta, lentificação, falhas de concentração e ideação passiva, definem o Transtorno Depressivo Maior (DSM-5-TR). O discriminador está nos antecedentes: episódios prévios com retorno ao funcionamento pleno entre eles e registro longitudinal só de rebaixamentos, ou seja, curso episódico sobre base eutímica. Isso afasta a Distimia (que exige cronicidade de 2 anos ou mais) e o Bipolar I (nenhuma elevação de humor já registrada); o eixo afetivo, e não a preocupação como traço antigo, afasta a Ansiedade Generalizada.'
    },
    {
      id:'toc', cat:'TOC e transtornos relacionados', nivel:'N2',
      ...
      vinheta:[
        'Mulher de 22 anos, estudante de graduação, procura atendimento porque a rotina ficou inviável. Ao longo do dia, surgem na cabeça dela imagens de germes e de sujeira invisível grudada na pele, e essas ideias voltam sozinhas mesmo quando tenta pensar em outra coisa; cada vez que isso ocorre, sente o corpo tensionar e a respiração acelerar até conseguir lavar as mãos numa ordem fixa de movimentos que precisa repetir do começo se errar a sequência. Somadas, a lavagem das mãos e as faxinas que faz no quarto ocupam mais de três horas por dia, deixam o dorso das mãos rachado e ardendo pelo sabão, e ela reconhece que o tamanho disso tudo não faz sentido, embora não consiga parar.',
        'Para não tocar superfícies que considera carregadas, segura a mochila contra o peito, empurra portas com o cotovelo e desistiu de pegar ônibus lotado, o que a faz sair de casa com muita antecedência e ainda assim chegar atrasada às aulas; nas semanas de prova relata noites mal dormidas e o coração disparado, que melhoram quando os exames terminam. Nega uso de álcool ou outras substâncias, nega febre ou dor, e nega qualquer ideia de se ferir. O quarto permanece organizado e sem excesso de objetos, e ela descarta sem dificuldade o que não usa; o desconforto só aparece atrelado às ideias de germes e ao alívio momentâneo que a limpeza traz.'
      ],
      pergunta:'Dentre as alternativas, qual o diagnóstico mais provável?',
      opts:['Transtorno de Ansiedade Generalizada','Transtorno de Pânico','Transtorno Obsessivo-Compulsivo','Transtorno de Acumulação'],
      correct:2,
      explicacao:'Pensamentos intrusivos recorrentes de contaminação acoplados a rituais de lavagem que consomem mais de três horas por dia, com sofrimento, prejuízo e crítica preservada, definem o Transtorno Obsessivo-Compulsivo (DSM-5-TR). A aflição está sempre ancorada no mesmo tema e é aliviada por um ato específico, não é uma preocupação difusa por vários assuntos (afasta a Ansiedade Generalizada); o coração disparado é situacional, ligado às provas, sem crises inesperadas de pico em minutos (afasta o Pânico); e o quarto permanece organizado, sem dificuldade de descartar (afasta a Acumulação).'
    },
    {
      id:'tept', cat:'Trauma e estressores', nivel:'N4',
      ...
      vinheta:[
        'Homem de 41 anos, motorista de caminhão, procura atendimento relatando que continua mal desde um capotamento ocorrido na estrada cinco meses atrás, no qual um colega de viagem morreu. Desde então tem flashes da batida e do som do metal se torcendo durante o dia, além de pesadelos quase toda noite com a cena do acidente. O som de uma buzina ou a aproximação de uma curva semelhante à do trecho desencadeiam reações corporais intensas, com taquicardia, suor e a sensação de reviver o momento. Parou de aceitar viagens que passem por rodovias, recusa terminantemente cruzar aquele ponto da pista e interrompe a conversa sempre que o assunto se aproxima do ocorrido.',
        'Em casa, descreve-se como mais calado e afastado, com dificuldade de se aproximar da esposa e dos filhos, dizendo sentir uma espécie de barreira que antes não existia. Mantém-se permanentemente em alerta, assusta-se com ruídos repentinos e dorme pouco, vigiando portas e janelas. Os episódios de mal-estar corporal surgem sempre ligados a algo que lembra a estrada ou o acidente, nunca de forma súbita e sem motivo aparente. Nega uso de álcool ou outras substâncias e nega ideação suicida.'
      ],
      pergunta:'Dentre as alternativas, qual o diagnóstico mais provável?',
      opts:['Transtorno de Estresse Agudo','Transtorno de Estresse Pós-Traumático','Transtorno de Pânico','Transtorno de Ajustamento'],
      correct:1,
      explicacao:'Síndrome traumática completa após um evento com risco de vida: revivências (flashes, pesadelos, reatividade a gatilhos), evitação ativa, distanciamento afetivo e hiperexcitação. O discriminador é a cronologia: o evento foi há cinco meses e os sintomas persistem, ou seja, mais de um mês, o que define o Transtorno de Estresse Pós-Traumático e afasta o Estresse Agudo (3 dias a 1 mês). As reações vêm sempre atreladas a lembranças do trauma, nunca em crises súbitas e imotivadas (afasta o Pânico), e a síndrome completa afasta o Transtorno de Ajustamento (residual).'
    },
    {
      id:'social', cat:'Transtornos de ansiedade', nivel:'N2',
      ...
      vinheta:[
        'Mulher de 19 anos, caloura de arquitetura, chegou ao serviço após quase trancar uma disciplina cujas notas dependiam de seminários. Há cerca de oito meses, sempre que precisa apresentar um trabalho diante da turma, falar com um professor ou comer no bandejão sob o olhar de desconhecidos, sente o rosto esquentar e ficar avermelhado, as mãos tremerem, a camiseta encharcar de suor e o coração disparar; antecipa por dias que vai gaguejar, parecer ridícula ou que todos vão reparar no quanto está nervosa. Por isso senta sempre nas últimas fileiras, troca apresentações com colegas quando consegue e, no dia do seminário, costuma faltar alegando mal-estar. Nega uso de substâncias, febre ou pensamentos de morte.',
        'Fora dessas situações, mantém o sono e o apetite preservados e descreve o restante da rotina sem maiores apreensões; quando está com o grupo de amigas próximas, no apartamento ou em festas pequenas, conversa de forma espontânea, conta piadas e lidera as brincadeiras, sem qualquer constrangimento. Relata que o desconforto surge de modo previsível, ligado ao momento em que sabe que poderá ser observada e julgada por quem não conhece bem, e não em episódios súbitos e inesperados em repouso. Não menciona preocupação flutuante com finanças, saúde da família, desempenho geral ou outros assuntos do dia a dia; suas queixas giram em torno do julgamento alheio sobre seu desempenho diante de plateia.'
      ],
      pergunta:'Dentre as alternativas, qual o diagnóstico mais provável?',
      ...
      correct:1,
      explicacao:'Medo acentuado e persistente de situações de avaliação social (apresentar, falar com professores, comer em público), com sintomas de escrutínio (rubor, tremor, sudorese, taquicardia), esquiva e prejuízo por cerca de oito meses, define o Transtorno de Ansiedade Social (DSM-5-TR). O desconforto é restrito ao contexto de avaliação e ausente entre as amigas próximas, onde é espontânea, o que afasta a Personalidade Esquiva (pervasiva); surge de modo previsível, não em crises do nada em repouso (afasta o Pânico); e não há preocupação difusa por vários temas (afasta a Ansiedade Generalizada).'
    },
    {
      id:'anorexia', cat:'Transtornos alimentares', nivel:'N2',
      ...
      vinheta:[
        'Adolescente de 17 anos, bailarina em companhia competitiva, levada pelos pais por perda de peso progressiva nos últimos meses. Reduziu as porções das refeições, deixou de comer pães, massas e doces, e mantém um caderno onde anota o valor calórico de cada item antes de aceitá-lo. Permanece na sala de ensaio além do horário das aulas e acrescenta sessões próprias de exercício em casa. Está bem abaixo do peso esperado para a idade e a estatura, refere que os ciclos menstruais ficaram espaçados e irregulares, e tem usado camisetas e calças folgadas que não usava antes. Nega uso de substâncias e ideação suicida.',
        'Diante do espelho do estúdio, descreve o próprio corpo como volumoso e afirma precisar afinar ainda mais as coxas e o abdômen para o papel que ensaia, comparando-se desfavoravelmente às colegas; a preocupação recai sobre o tamanho e o contorno do corpo como um todo, sem que aponte alguma parte do rosto ou característica física isolada que considere defeituosa. Sobe na balança várias vezes ao longo do dia e registra cada número. As refeições seguem um padrão constante de pequena quantidade, sem relatos de episódios em que comeu muito além do habitual em pouco tempo com sensação de não conseguir parar, e a família não observou vômitos, uso de laxantes nem períodos de jejum após comer. Exames de triagem clínica e tireoide dentro da normalidade.'
      ],
      pergunta:'Dentre as alternativas, qual o diagnóstico mais provável?',
      opts:['Bulimia Nervosa','Anorexia Nervosa','Transtorno de Compulsão Alimentar','Transtorno Dismórfico Corporal'],
      correct:1,
      explicacao:'Restrição alimentar que leva a peso significativamente baixo para a idade e a estatura, somada a medo de engordar (exercício excessivo, vigilância do peso) e a perturbação da percepção do corpo (vê-se volumosa), define a Anorexia Nervosa (DSM-5-TR). Não há episódios de compulsão seguidos de vômito, laxante ou jejum e o peso está baixo, o que afasta a Bulimia (peso costuma ser normal) e o Transtorno de Compulsão Alimentar (sem compensação); e a preocupação recai sobre o tamanho e o contorno do corpo como um todo, não sobre um defeito físico específico (afasta o Dismórfico).'
    },
    {
      id:'bipolar1', cat:'Transtorno bipolar e relacionados', nivel:'N3',
      ...
      vinheta:[
        'Homem de 29 anos, levado por familiares ao pronto-socorro por uma mudança abrupta no comportamento iniciada há cerca de sete dias. Desde então, mantém-se eufórico e expansivo, fala de modo torrencial e quase ininterrupto, saltando de um tema a outro sem concluir nenhum, e descreve-se como uma pessoa de capacidades acima das demais, repleta de ideias que considera revolucionárias. Dorme apenas duas a três horas por noite e levanta-se disposto, sem qualquer relato de cansaço. Nesse mesmo intervalo, registrou a abertura de uma empresa em um único dia, realizou compras que ultrapassaram o limite do cartão e fechou acordos comerciais de alto risco; reage com irritação quando confrontado sobre essas decisões.',
        'No mesmo período de sete dias, deixou de comparecer ao trabalho e entrou em conflito aberto com sócios, ao ponto de os familiares julgarem necessário o atendimento imediato e o conduzirem ao serviço. Como único antecedente relevante, refere que, no ano anterior, atravessou alguns meses em que permaneceu desanimado e retraído, sem que isso o levasse a buscar ajuda. Nega uso de álcool ou outras substâncias e nega ideação suicida; o exame físico não evidencia febre ou outras alterações.'
      ],
      pergunta:'Dentre as alternativas, qual o diagnóstico mais provável?',
      opts:['Transtorno Bipolar Tipo II','Transtorno Bipolar Tipo I','Transtorno Ciclotímico','Transtorno Depressivo Maior'],
      correct:1,
      explicacao:'Humor elevado e expansivo por pelo menos uma semana, com grandiosidade, redução da necessidade de sono (2 a 3 h, disposto), fala torrencial saltando de assunto e envolvimento em atividades de risco (empresa aberta num dia, compras acima do limite, negócios arriscados), define um episódio maníaco. O discriminador é o prejuízo acentuado com necessidade de intervenção (faltou ao trabalho, rompeu com sócios, conduzido ao pronto-socorro), o que caracteriza o Transtorno Bipolar Tipo I; a hipomania do Tipo II não causa esse prejuízo, a Ciclotimia exige sintomas subliminares por dois anos, e a fase "pra baixo" do ano anterior não muda o quadro, já que um episódio maníaco define o Tipo I.'
    },
    {
      id:'tag', cat:'Transtornos de ansiedade', nivel:'N2',
      ...
      vinheta:[
        'Mulher de 45 anos, gerente de loja, encaminhada pela clínica geral em 06/2026 após avaliação cardiológica e função tireoidiana normais. Desde 10/2025 mostra-se apreensiva na maior parte dos dias, com uma sucessão de assuntos que se alternam ao longo do dia: o orçamento doméstico, a saúde dos pais idosos, o rendimento da loja e o trajeto do filho até a escola. Tenta deixar esses temas de lado mas não consegue interromper a corrente, que se mantém de fundo enquanto realiza outras atividades, e liga mais de uma vez ao dia para confirmar que os pais e o filho estão bem. Dorme de quatro a cinco horas, com despertar precoce.',
        'Tem cefaleia tensional recorrente e faz fisioterapia por contratura cervical e de trapézios; suspendeu o café há cerca de um mês, sem alteração do quadro, e nega uso de substâncias, ideação suicida ou episódios febris. Aceitou ser paraninfa da turma de formandos e mantém participação habitual nas reuniões. Na avaliação apresenta inquietação discreta, manipulando as mãos, refere cansaço já no meio da manhã e afeto apreensivo; o pensamento tem curso preservado, com conteúdo centrado nos temas referidos, e reconhece a apreensão como desproporcional.'
      ],
      pergunta:'Dentre as alternativas, qual o diagnóstico mais provável?',
      ...
      correct:1,
      explicacao:'Preocupação excessiva e difícil de controlar sobre múltiplos domínios (finanças, saúde dos pais, loja, segurança do filho), na maior parte dos dias por cerca de 8 meses (10/2025 a 06/2026), com inquietação, fadiga, tensão muscular cervical e sono reduzido, define o Transtorno de Ansiedade Generalizada (DSM-5-TR). A apreensão é difusa e de fundo contínuo, não em crises súbitas com pico em minutos (afasta o Pânico); aceitar a paraninfa e manter as reuniões mostra que o medo não se restringe à avaliação social (afasta a Fobia Social); e ligar para confirmar que estão bem expressa a própria preocupação, não um ritual para neutralizar uma obsessão (afasta o TOC).'
    },
    {
      id:'bipolar2', cat:'Transtorno bipolar e relacionados', nivel:'N3',
      ...
      vinheta:[
        'Mulher de 31 anos, professora, que há cerca de cinco semanas apresenta queda progressiva do interesse pelas atividades habituais, despertar espontâneo por volta das 4h30 sem retorno ao sono, redução do apetite com perda de aproximadamente 3 kg, lentificação das tarefas cotidianas e discurso recorrente de pouco valor próprio. Procurou avaliação por insistência de colegas de trabalho e nega ideação suicida ou planejamento.',
        'Houve dois períodos semelhantes ao atual, cada um com cerca de dois meses, aos 24 e aos 27 anos, ambos com remissão. O marido e colegas referem que, em ocasiões esparsas e por quatro a cinco dias seguidos, ela “engata outra marcha”: dorme cerca de três horas sem demonstrar cansaço no dia seguinte, fala muito mais que o habitual e assume vários projetos ao mesmo tempo, “a mil”, mantendo a rotina de trabalho e da casa sem que ninguém precisasse intervir e sem afastamento ou internação. A mãe está em acompanhamento para depressão. Na avaliação apresenta-se lentificada, com afeto entristecido e congruente, discurso de ritmo reduzido e juízo crítico mantido.'
      ],
      pergunta:'Dentre as alternativas, qual o diagnóstico mais provável?',
      opts:['Transtorno Bipolar Tipo I','Transtorno Depressivo Maior','Transtorno Bipolar Tipo II','Transtorno Ciclotímico'],
      correct:2,
      explicacao:'A paciente apresenta-se em episódio depressivo maior (anedonia, despertar precoce, perda ponderal, lentificação, desvalia), mas o colateral descreve períodos de 4 a 5 dias com redução da necessidade de sono (3 h sem cansaço), aumento de fala e de atividade dirigida, observáveis por terceiros e sem prejuízo acentuado, internação ou psicose: episódio hipomaníaco. Depressão maior somada a hipomania, sem mania, define o Transtorno Bipolar Tipo II (DSM-5-TR). Ter mantido a rotina e nunca ter internado afasta o Tipo I (mania); a presença da hipomania reclassifica o quadro e afasta a Depressão Maior; e os episódios depressivos completos prévios afastam a Ciclotimia (subliminar e crônica). A mãe com depressão é apenas antecedente familiar.'
    },
    {
      id:'distimia', cat:'Transtornos depressivos', nivel:'N3',
      ...
      vinheta:[
        'Homem de 38 anos, analista de sistemas, comparece à consulta levado pela esposa, que convive com um marido que descreve como sempre meio apagado; para ele, ser assim é apenas o seu jeito, e o que motiva a esposa não lhe parece motivo de preocupação. Questionado sobre a última vez em que se sentiu de fato bem, hesita e não consegue apontar nenhum período além de algumas semanas esparsas desde que entrou na vida adulta, por volta dos vinte anos. No dia a dia mantém o emprego, cumpre prazos e sustenta a rotina doméstica, mas relata fazer tudo no automático, sem o que chama de brilho.',
        'Refere-se a si mesmo como abatido na maior parte do dia, em mais dias do que não, num estado que vem se arrastando de modo contínuo desde antes do nascimento do filho mais novo, que hoje tem quatro anos, sem que tenha havido uma quinzena isolada em que o quadro se aprofundasse de forma distinta do seu padrão habitual. Acompanham o relato uma avaliação rebaixada de si, uma expectativa pessimista quanto ao futuro, energia escassa ao longo do dia e demora para se concentrar e para tomar decisões corriqueiras. Conta que se preocupa com contas e com o trabalho, embora situe essas preocupações como secundárias ao fundo de desânimo que sente. Nega ideação suicida e uso de álcool ou outras substâncias.'
      ],
      pergunta:'Dentre as alternativas, qual o diagnóstico mais provável?',
      ...
      correct:1,
      explicacao:'Humor deprimido na maior parte do dia, em mais dias do que não, por bem mais de dois anos sem remissão sustentada (a cronologia se ancora no filho de quatro anos), com baixa autoestima, pessimismo, baixa energia e dificuldade de concentração e decisão, define o Transtorno Depressivo Persistente (Distimia) (DSM-5-TR). O discriminador é a ausência de uma quinzena isolada em que o quadro piorasse de forma distinta do habitual: é cronicidade de baixo grau, não um episódio discreto (afasta o Depressivo Maior). Sem qualquer fase de humor elevado (afasta a Ciclotimia), e as preocupações com contas e trabalho são secundárias ao desânimo de fundo (afasta a Ansiedade Generalizada).'
    },
    {
      id:'dismorfico', cat:'TOC e transtornos relacionados', nivel:'N2',
      ...
      vinheta:[
        'Mulher de 24 anos, encaminhada pelo serviço de dermatologia depois de solicitar, pela terceira vez, um procedimento cirúrgico que o médico avaliou não ter indicação técnica. Está convencida de que carrega no rosto um defeito grave, descreve a própria pele como horrível e o nariz como torto, ainda que familiares e colegas afirmem não notar nada de diferente e a tenham, por várias vezes, considerado bonita. Passa horas diante do espelho, em alguns momentos cutuca a pele em busca de imperfeições, em outros a recobre com camadas sucessivas de maquiagem; tira dezenas de fotos do rosto e as apaga em seguida, posiciona o próprio perfil ao lado do de outras pessoas para conferir o contorno e pergunta repetidamente a quem está por perto se está feia, sem se tranquilizar com as respostas.',
        'Reduziu encontros sociais, deixou de ir à praia e recusa qualquer foto de grupo; relata que, quando aceita sair, fica o tempo todo apreensiva sobre como o rosto aparece para os demais. O peso corporal é adequado, alimenta-se sem restrições e nunca se queixou da forma do corpo fora da face. As checagens e a busca por confirmação orbitam por completo o aspecto da pele e do nariz, e não temas de sujeira, germes ou contaminação; nega uso de substâncias e ideação suicida. O que organiza o quadro é a certeza inabalável a respeito daquele defeito específico do rosto, ocupando a maior parte das horas do dia e atrapalhando trabalho e relações.'
      ],
      pergunta:'Dentre as alternativas, qual o diagnóstico mais provável?',
      ...
      correct:1,
      explicacao:'Preocupação com um defeito percebido na aparência (pele e nariz), imperceptível para os outros, com comportamentos repetitivos (horas no espelho, cutucar a pele, camuflar, fotografar e apagar, comparar-se, buscar reasseguramento) e prejuízo, define o Transtorno Dismórfico Corporal (DSM-5-TR). As checagens orbitam só a aparência, não sujeira ou contaminação (afasta o TOC); o peso e a alimentação são adequados, sem queixa do corpo fora da face (afasta a Anorexia); e o que organiza o quadro é a certeza sobre o defeito específico, não um medo genérico de avaliação social (afasta a Fobia Social).'
    },
    {
      id:'estresse_agudo', cat:'Trauma e estressores', nivel:'N4',
      ...
      vinheta:[
        'Homem de 28 anos, entregador de aplicativo, atendido em 24/06 após ter sido abordado por um assaltante armado em 10/06, ocasião em que pensou que seria morto. Desde a primeira semana, lembranças repetitivas e nítidas do episódio irrompem sem aviso ao longo do dia, acompanhadas de pesadelos com o assalto e despertares noturnos, dormindo cerca de quatro horas por noite. Há momentos em que se percebe “fora de si”, como se observasse o próprio corpo à distância, e em que o ambiente lhe parece artificial e sem nitidez.',
        'Mantém-se sobressaltado a ruídos súbitos e em vigilância contínua, deixou de transitar pela região do ocorrido, de assistir a noticiários e de comentar o assunto, e a esposa relata que passou a verificar portas e janelas várias vezes à noite e reduziu as saídas de casa. O quadro permanece estável desde o início, sem dias livres de sintomas, e o temor segue ligado ao episódio específico, ativado por estímulos que o evocam. Nega uso de substâncias e ideação suicida; o juízo crítico está preservado e o funcionamento laboral permanece interrompido desde a data do assalto.'
      ],
      pergunta:'Dentre as alternativas, qual o diagnóstico mais provável?',
      opts:['Transtorno de Estresse Pós-Traumático','Transtorno de Estresse Agudo','Transtornos de Adaptação','Transtorno de Pânico'],
      correct:1,
      explicacao:'Síndrome traumática completa após exposição a evento com risco de vida: intrusão (lembranças vívidas, pesadelos), dissociação (despersonalização e desrealização), evitação (locais, conversas, notícias) e hiperexcitação (sobressalto, vigilância, sono fragmentado). O discriminador é a cronologia: evento em 10/06 e avaliação em 24/06, cerca de duas semanas, dentro do primeiro mês. Como o Transtorno de Estresse Agudo dura de 3 dias a 1 mês, é esse o diagnóstico; o Transtorno de Estresse Pós-Traumático exigiria persistência além de 1 mês. A síndrome traumática completa afasta o Transtorno de Adaptação (categoria residual), e o medo atrelado ao trauma, e não em crises espontâneas, afasta o Pânico.'
    },
    {
      id:'bulimia', cat:'Transtornos alimentares', nivel:'N2',
      ...
      vinheta:[
        'Mulher de 23 anos, universitária, procura atendimento envergonhada, falando em voz baixa e evitando contato visual ao tocar no assunto da alimentação. Relata que, várias vezes por semana há cerca de oito meses, tranca-se sozinha no quarto ao fim da tarde e ingere, em menos de uma hora, quantidades de comida muito acima do que comeria em uma refeição comum, biscoitos, pães, sobras e doces de uma vez, com a sensação de que não consegue parar enquanto não acaba tudo. Mantém o hábito escondido das colegas de república e guarda embalagens vazias no fundo da mochila para descartar fora de casa. Refere noites mal dormidas às vésperas de provas e períodos de ânimo mais baixo, mas sem perda de interesse pelas atividades do curso, que segue frequentando.',
        'Logo após esses episódios, tomada por culpa e por um medo intenso de ganhar peso, vai ao banheiro e induz o vômito; em algumas semanas mais agitadas alterna isso com caixas de laxante, dias inteiros sem comer e sessões longas de academia até a exaustão. Avalia o próprio dia como bem ou mal sucedido conforme o número que vê na balança de manhã e conforme a roupa parecer mais ou menos justa, e diz que sua imagem diante do espelho define seu humor. Ao exame, o peso encontra-se dentro da faixa esperada para a altura e os sinais vitais estão estáveis; nega uso de substâncias e nega pensamentos de morte. Os marcos do calendário acadêmico que cita situam o início do padrão no começo do semestre anterior.'
      ],
      pergunta:'Dentre as alternativas, qual o diagnóstico mais provável?',
      opts:['Anorexia Nervosa','Transtorno de Compulsão Alimentar','Bulimia Nervosa','Transtorno Depressivo Maior'],
      correct:2,
      explicacao:'Episódios recorrentes de ingestão em pouco tempo de quantidade muito maior que o usual, com perda de controle, seguidos de comportamentos compensatórios (vômito, laxantes, jejum, exercício extenuante), várias vezes por semana há cerca de oito meses, com autoavaliação dominada pelo peso e pela forma, definem a Bulimia Nervosa (DSM-5-TR). O peso está na faixa normal, o que afasta a Anorexia (peso significativamente baixo); há sempre compensação após a compulsão, o que afasta o Transtorno de Compulsão Alimentar (sem compensação); e o ânimo baixo é reativo e sem perda de interesse, sem explicar o padrão alimentar (afasta o Depressivo Maior).'
    },
    {
      id:'tdah', cat:'Transtornos do neurodesenvolvimento', nivel:'N1',
      ...
      vinheta:[
        'Menino de 9 anos, no 4º ano, levado pela mãe por queixas recorrentes da escola. Desde o início da vida escolar, a professora observa que se levanta da carteira durante a aula, responde antes de a pergunta terminar e abandona as atividades antes de concluí-las. Em casa o quadro se repete: extravia o material, esquece os recados e deixa as tarefas pela metade, sendo necessário repetir as orientações para que conclua o que começa.',
        'Os marcos do desenvolvimento transcorreram sem intercorrências e não há doenças ou medicações prévias. Durante a avaliação mostra-se inquieto na cadeira, manipulando objetos, com fala espontânea e bom contato; no recreio brinca e conversa com os colegas e mantém amizades, e em sala atende ao que a professora pede. A dificuldade de atenção aparece de forma semelhante na leitura e na matemática, e o desempenho exige acompanhamento constante. Juízo crítico e afeto adequados para a idade.'
      ],
      pergunta:'Dentre as alternativas, qual o diagnóstico mais provável?',
      ...
      correct:2,
      explicacao:'Desatenção e hiperatividade/impulsividade com início antes dos 12 anos, presentes em dois ambientes (escola e casa) e com prejuízo, definem o Transtorno de Déficit de Atenção/Hiperatividade (DSM-5-TR). Manter amizades e bom contato afasta o Espectro Autista; atender ao que a professora pede, sem hostilidade dirigida, afasta o Transtorno de Oposição Desafiante; e a dificuldade aparecer igual na leitura e na matemática, não restrita a uma habilidade, afasta o Transtorno Específico da Aprendizagem.'
    },
    {
      id:'autismo', cat:'Transtornos do neurodesenvolvimento', nivel:'N2',
      ...
      vinheta:[
        'Menino de 4 anos levado pelos pais por quase não falar e por dar a impressão de viver em um mundo próprio. Desde os primeiros meses desviava o olhar quando alguém tentava se aproximar, não estendia o dedo para apontar o que queria mostrar e poucas vezes virava a cabeça ao ser chamado pelo nome. No parquinho, fica à parte das outras crianças e não demonstra interesse em se juntar a elas; em casa, nunca encena cenas com bonecos nem finge dar comida a um ursinho, atividades comuns para a idade. Os pais não relatam períodos de afastamento dos cuidadores nem trocas de domicílio; a criança foi criada pela mãe e pelo pai desde o nascimento, em ambiente estável.',
        'Passa horas alinhando os carrinhos em fila e, em seguida, gira as rodas de um deles repetidamente, sempre da mesma maneira. Qualquer alteração na rotina (um caminho diferente para a creche, a troca do prato habitual) provoca choro intenso e demorado. Quando se entusiasma, sacode as mãos no ar; cobre os ouvidos diante do som do liquidificador e recusa roupas de certos tecidos, chorando ao contato. Todos esses comportamentos, segundo os pais, estão presentes desde muito cedo. O exame nega febre, e a triagem não identificou uso de medicações ou eventos perinatais relevantes.'
      ],
      pergunta:'Dentre as alternativas, qual o diagnóstico mais provável?',
      ...
      correct:2,
      explicacao:'Déficits persistentes na comunicação e interação social (desvia o olhar, não aponta para mostrar, pouca resposta ao nome, isolamento dos pares, ausência de faz-de-conta) somados a padrões restritos e repetitivos (enfileirar carrinhos e girar rodas, sofrimento intenso com mudança de rotina, sacudir as mãos, hiper-reatividade a sons e texturas), de início precoce, definem o Transtorno do Espectro Autista (DSM-5-TR). É a coexistência do prejuízo social com os comportamentos repetitivos que afasta o Transtorno da Comunicação Social (sem os repetitivos) e a Deficiência Intelectual (sem a defasagem social específica); e ter sido criado em ambiente estável, sem rupturas de cuidado, afasta o Transtorno de Apego Reativo.'
    },
    {
      id:'esquizofrenia', cat:'Espectro da esquizofrenia e psicóticos', nivel:'N3',
      ...
      vinheta:[
        'Homem de 23 anos, universitário, levado pela família a uma consulta em junho de 2026. Os familiares relatam que, desde maio de 2025, ele foi se afastando dos colegas e deixando de comparecer às aulas, até trancar o curso; passou a permanecer a maior parte do tempo fechado no quarto, deixou de tomar banho com regularidade e abandonou atividades que antes lhe davam prazer, sem que houvesse, em nenhum momento, períodos de ânimo elevado, gastos impulsivos ou redução da necessidade de sono. A família procurou ajuda após uma piora acentuada iniciada por volta de fevereiro de 2026.',
        'Nos meses mais recentes, ele afirma estar sendo monitorado por uma organização que o teria escolhido, e diz que a programação da televisão traz recados endereçados a ele. Quando está sozinho, escuta uma ou mais vozes que descrevem em voz alta aquilo que ele faz, e ao falar muda repetidamente de assunto de modo que o interlocutor não consegue acompanhar o raciocínio. Nega uso de substâncias, febre ou intenção de se ferir. O desempenho acadêmico, o autocuidado e o convívio, comparados ao ano anterior, encontram-se muito abaixo do que o paciente apresentava.'
      ],
      pergunta:'Dentre as alternativas, qual o diagnóstico mais provável?',
      opts:['Transtorno Esquizofreniforme','Transtorno Psicótico Breve','Esquizofrenia','Transtorno Bipolar Tipo I'],
      correct:2,
      explicacao:'Delírios (perseguição, ideias de referência pela televisão), alucinações auditivas (vozes que comentam suas ações) e discurso desorganizado, com sintomas negativos e declínio funcional acentuado, definem a Esquizofrenia (DSM-5-TR). O discriminador é a cronologia: o quadro começa em maio de 2025 e a consulta é em junho de 2026, mais de doze meses no total, o que afasta o Transtorno Esquizofreniforme (1 a 6 meses) e o Psicótico Breve (menos de 1 mês). A ausência de qualquer ânimo elevado, gastos impulsivos ou redução do sono, com psicose persistente fora de alteração do humor, afasta o Bipolar Tipo I.'
    },
    {
      id:'delirante', cat:'Espectro da esquizofrenia e psicóticos', nivel:'N3',
      ...
      vinheta:[
        'Homem de 52 anos, gerente, comparece à consulta trazido pela esposa, que relata uma mudança instalada nos últimos sete ou oito meses: ele se diz certo de que ela mantém um caso com outra pessoa e organiza o dia em torno disso. Confere o celular dela várias vezes, registra horários de chegada, refaz mentalmente trajetos que ela descreve e já a acompanhou de carro até o trabalho para checar onde ela parava. Um cumprimento da vizinha, uma mensagem de colega, um atraso de quinze minutos no supermercado: cada coisa entra como pedaço que confirma a mesma conclusão. Apresentado à agenda da esposa, a recibos e a explicações pontuais, ele ouve, reconhece que parece comum, e em seguida reencaixa tudo na suposta traição. Nega ideação suicida e uso de substâncias.',
        'No mesmo período segue gerenciando a equipe sem queixas no trabalho, cumpre prazos, comparece bem cuidado, mantém sono e refeições no horário e conversa de forma clara e organizada sobre qualquer outro tema, sem que conhecidos notem algo estranho fora de casa. Descreve a própria certeza como um fato que ele lamenta ter descoberto, e não como uma ideia incômoda que lhe invade a mente contra a vontade e que ele tente afastar ou conferir para se acalmar. Antes desses meses, a esposa o descreve como alguém que confiava nas pessoas e nas relações próximas, sem histórico de viver achando que colegas, vizinhos ou familiares quisessem prejudicá-lo.'
      ],
      pergunta:'Dentre as alternativas, qual o diagnóstico mais provável?',
      opts:['Esquizofrenia','Transtorno Delirante','Transtorno Obsessivo-Compulsivo','Transtorno da Personalidade Paranoide'],
      correct:1,
      explicacao:'Uma crença delirante de ciúme/infidelidade, presente por sete a oito meses, plausível mas inabalável e resistente a evidências, com funcionamento preservado fora do tema, define o Transtorno Delirante (DSM-5-TR). Segue gerenciando a equipe, cuidando-se e conversando de forma organizada sobre qualquer outro tema, sem alucinações nem declínio, o que afasta a Esquizofrenia; vive a certeza como um fato real, não como ideia indesejada que tenta neutralizar conferindo (afasta o TOC); e é uma crença única e recente, num homem antes confiante, não uma desconfiança difusa de longa data (afasta a Personalidade Paranoide).'
    },
    {
      id:'dissociativo_id', cat:'Transtornos dissociativos', nivel:'N3',
      ...
      vinheta:[
        'Mulher de 30 anos procura avaliação depois de um período em que, ao chegar em casa, encontrou no armário peças de roupa e objetos que não reconhece e cujas compras não constam em sua memória. Relata trechos do dia, por vezes horas inteiras, dos quais não guarda qualquer registro do que fez ou de onde esteve, lacunas que vão muito além de esquecer onde deixou as chaves ou nomes de conhecidos. Conhecidos a abordam descrevendo conversas recentes que ela não consegue situar, em algumas delas referindo-se a ela por outro nome e comentando uma forma de se expressar, preferências e até gostos que ela considera estranhos ao que reconhece como seu. Em determinados momentos, descreve a impressão de que o controle dos próprios atos passa a ser conduzido por alguém que não ela, sem que depois consiga reconstruir o que se passou nesse intervalo.',
        'Refere histórico de maus-tratos graves e repetidos na primeira infância. Nega uso de substâncias e febre ou outra condição clínica recente; nega ideação suicida atual. Ao longo do atendimento mantém o curso do pensamento organizado e a percepção preservada, sem captar mensagens ou comandos vindos do ambiente. As lacunas de memória não se restringem ao evento de infância, repetem-se no cotidiano e coincidem com os intervalos em que terceiros relatam tê-la encontrado agindo e se apresentando de modo que ela própria não reconhece como seu.'
      ],
      pergunta:'Dentre as alternativas, qual o diagnóstico mais provável?',
      opts:['Amnésia Dissociativa','Transtorno Dissociativo de Identidade','Transtorno da Personalidade Borderline','Esquizofrenia'],
      correct:1,
      explicacao:'Ruptura da identidade com estados de personalidade distintos (terceiros a abordam por outro nome, com modos e gostos que ela não reconhece; sensação de que outra pessoa assume o controle) somada a falhas recorrentes de memória para o cotidiano, muito além do esquecimento comum, definem o Transtorno Dissociativo de Identidade (DSM-5-TR), com o abuso grave na infância como etiologia típica. As lacunas de memória sozinhas seriam Amnésia Dissociativa, mas há os estados alternantes; o pensamento organizado e a percepção preservada afastam a Esquizofrenia; e a descontinuidade está na própria identidade, observada externamente assumindo o controle com amnésia para o intervalo, não numa autoimagem instável (afasta o Borderline).'
    },
    {
      id:'amnesia_dissociativa', cat:'Transtornos dissociativos', nivel:'N2',
      ...
      vinheta:[
        'Homem de 35 anos, sem histórico psiquiátrico conhecido, é trazido por terceiros após ser localizado em uma rodovia, andando a esmo e com aparência confusa quanto a onde estava e como havia chegado ali. Orientado quanto a tempo, identifica corretamente o dia e o local atuais, reconhece objetos e nomeia familiares pelo grau de parentesco, mas, ao ser questionado sobre os últimos dias, fica em silêncio e relata um vazio para esse período. Quatro dias antes, segundo registros trazidos pela família, esteve envolvido em um acidente de trânsito grave no qual um irmão veio a falecer; ele não consegue recuperar nada desse episódio nem dos contatos e decisões que se seguiram, ainda que descreva sem dificuldade a infância, a profissão e a rotina anterior. Mantém atenção, linguagem fluente e raciocínio preservados ao longo da avaliação, executa cálculos e segue instruções de várias etapas sem falhas, e nega uso de álcool ou outras substâncias nos dias recentes.',
        'A perda de memória concentra-se nas informações pessoais ligadas ao acidente e aos dias seguintes, e é desproporcional a qualquer esquecimento comum. Não há deterioração progressiva das demais funções cognitivas, como ocorreria numa demência, e ao longo da avaliação ele não apresenta momentos em que assuma outro nome ou outra forma de se comportar. O que domina o quadro é a própria lacuna de memória autobiográfica, e não imagens ou pesadelos que reproduzam o evento de forma intrusiva.'
      ],
      pergunta:'Dentre as alternativas, qual o diagnóstico mais provável?',
      ...
      correct:1,
      explicacao:'Incapacidade de recordar informações autobiográficas importantes ligadas a um evento estressante (o acidente e os dias seguintes), desproporcional ao esquecimento comum e sem causa neurológica ou por substância, define a Amnésia Dissociativa (DSM-5-TR). Não há estados de identidade alternantes, o que afasta o Transtorno Dissociativo de Identidade; as demais funções cognitivas estão preservadas, sem declínio progressivo, o que afasta o Transtorno Neurocognitivo; e domina a lacuna de memória, não revivências intrusivas do trauma, o que afasta o Estresse Pós-Traumático.'
    },
    {
      id:'somaticos', cat:'Sintomas somáticos e relacionados', nivel:'N3',
      ...
      vinheta:[
        'Mulher de 48 anos, profissional administrativa, com queixa de queimação no estômago, plenitude após as refeições, dor lombar de localização variável e episódios de tontura, presentes na maior parte dos dias desde meados de 2023. Em março de 2024 reduziu a jornada de trabalho e em maio suspendeu as caminhadas que mantinha. Ao longo de cerca de quatorze meses passou por cinco profissionais, trocando sucessivamente por insatisfação com as conclusões, e traz uma pasta com endoscopia, ultrassonografia abdominal, colonoscopia e eletrocardiograma, todos normais.',
        'Mantém um caderno com o horário de cada sintoma e o alimento ingerido, afere a pressão arterial três a quatro vezes ao dia e dedica parte das noites à leitura sobre doenças graves, com alívio de poucas horas após cada consulta de resultado normal; a mãe faleceu de neoplasia gástrica. No conjunto, dedica em média duas a três horas diárias ao monitoramento das sensações corporais. Ao exame, a marcha, a força, a sensibilidade e a coordenação estão preservadas, e o discurso é fluente e centrado nas sensações físicas e no significado que atribui a elas. O afeto varia conforme o assunto, sorri ao falar das filhas e mantém satisfação nas tarefas habituais nos dias de menor sintoma, com crítica parcial quanto ao tempo dedicado à saúde.'
      ],
      pergunta:'Dentre as alternativas, qual o diagnóstico mais provável?',
      ...
      correct:1,
      explicacao:'Sintomas somáticos reais e proeminentes (queimação epigástrica, empachamento, dor lombar migratória, tontura), presentes na maior parte dos dias e incapacitantes (reduziu a jornada, parou as caminhadas), somados a pensamentos e comportamentos desproporcionais e persistentes (caderno de sintomas, aferir a pressão três a quatro vezes ao dia, pesquisa noturna, peregrinação por exames), definem o Transtorno de Sintomas Somáticos (DSM-5-TR). É a proeminência dos sintomas físicos que o separa da Ansiedade de Doença, em que os sintomas são mínimos e o foco é o medo de adoecer (mesmo com a mãe falecida por neoplasia como isca). O exame neurológico normal afasta o quadro Conversivo, e o afeto reativo com prazer preservado nos dias melhores afasta a Depressão.'
    },
    {
      id:'ansiedade_doenca', cat:'Sintomas somáticos e relacionados', nivel:'N3',
      ...
      vinheta:[
        'Homem de 36 anos, analista de seguros, busca atendimento já com um envelope de exames recentes na mão, todos dentro da normalidade segundo os laudos que apresenta. No geral relata se sentir bem do corpo, descreve no máximo uma fisgada eventual no peito ou a percepção de um batimento que sai do compasso, sensações que duram segundos e não o limitam nas atividades. Cada uma dessas percepções, porém, acende nele a convicção de que carrega uma doença grave ainda não identificada pelos médicos, ora um câncer em estágio silencioso, ora uma falha no coração prestes a se manifestar. Conta que passa horas das noites lendo sobre essas condições e comparando relatos com o que sente, e que já marcou nova consulta para a semana seguinte mesmo tendo recebido alta cardiológica há pouco.',
        'Quando um profissional o tranquiliza com base nos achados normais, o alívio dura um ou dois dias e ele logo procura outro especialista, convencido de que algo escapou; nos últimos doze meses trocou de clínico quatro vezes e refez o mesmo painel sanguíneo de três em três meses. O comportamento de checagem se restringe a marcar exames, reler laudos e pesquisar; não descreve um pensamento que invada a mente contra a sua vontade nem um gesto repetido que precise executar para acalmar a aflição. Seu desconforto orbita única e exclusivamente em torno da saúde e da possibilidade de adoecer, sem que outras esferas da vida (trabalho, dinheiro, família) figurem entre os motivos de sua inquietação. Nega uso de substâncias e ideação suicida; o quadro vem se mantendo estável nesse padrão desde, ao menos, o ano anterior.'
      ],
      pergunta:'Dentre as alternativas, qual o diagnóstico mais provável?',
      ...
      correct:1,
      explicacao:'Preocupação persistente de ter ou contrair uma doença grave, com sintomas somáticos mínimos ou fugazes (uma fisgada, um batimento que dura segundos) e comportamentos excessivos de checagem (repetir exames, trocar de médico, pesquisar) por mais de seis meses, definem o Transtorno de Ansiedade de Doença (DSM-5-TR). Como os sintomas físicos são mínimos e o foco é o medo da doença, afasta-se o Transtorno de Sintomas Somáticos (sintomas físicos proeminentes); a inquietação é monotemática, só a saúde, o que afasta a Ansiedade Generalizada; e não há pensamento intrusivo seguido de ritual para neutralizar, o que afasta o TOC.'
    },
    {
      id:'enurese', cat:'Transtornos da eliminação', nivel:'N1',
      ...
      vinheta:[
        'Menino de 7 anos, levado à avaliação porque molha a cama quase toda noite, com episódios pelo menos duas a três vezes por semana há vários meses. A perda de urina ocorre de forma involuntária, sobretudo durante o sono, e nunca houve um período seco desde que largou as fraldas. Os pais relatam que ele já recusa convites para dormir na casa de amigos por se sentir constrangido com a situação.',
        'A investigação clínica e laboratorial não encontrou infecção urinária, diabetes ou qualquer outra causa física que explique o quadro. As roupas de baixo e a roupa de cama permanecem manchadas apenas por urina ao despertar. Na escola e em casa, mantém rendimento e concentração compatíveis com a idade, brinca e se separa dos cuidadores sem sofrimento desproporcional, e seu desenvolvimento motor e cognitivo segue dentro do esperado.'
      ],
      pergunta:'Dentre as alternativas, qual o diagnóstico mais provável?',
      opts:['Encoprese','Enurese','Transtorno de Ansiedade de Separação','Transtorno de Déficit de Atenção/Hiperatividade'],
      correct:1,
      explicacao:'Eliminação repetida de urina na cama, ao menos duas vezes por semana por vários meses, em criança de sete anos e sem causa médica (infecção e diabetes afastados), caracteriza a Enurese (DSM-5-TR), aqui no subtipo noturno e primário. As roupas estão manchadas só por urina, sem perda de fezes, o que afasta a Encoprese; a criança se separa dos cuidadores sem sofrimento desproporcional (a recusa de dormir fora é vergonha da molhadela), o que afasta a Ansiedade de Separação; e mantém rendimento e concentração, o que afasta o TDAH.'
    },
    {
      id:'encoprese', cat:'Transtornos da eliminação', nivel:'N1',
      ...
      vinheta:[
        'Menina de 6 anos, levada à avaliação após meses de episódios repetidos de evacuação na própria roupa, ocorrendo mais de uma vez por mês. No início a família interpretou o quadro como teimosia, mas em diversas ocasiões a criança só percebe que sujou a roupa quando já sente o cheiro ou é avisada por terceiros, sem qualquer intenção aparente de provocar ou contrariar os adultos.',
        'A avaliação clínica e os exames não identificaram doença intestinal nem outra causa física que justifique o quadro, e a perda de fezes acontece em locais inadequados como a roupa e o ambiente escolar. A menina interage normalmente com colegas e professores, faz amizades e acompanha a rotina sem dificuldades de linguagem ou de reciprocidade social; não há relato de perda involuntária de urina, e o principal impacto descrito é a vergonha diante dos colegas e o crescente isolamento na escola após os episódios.'
      ],
      pergunta:'Dentre as alternativas, qual o diagnóstico mais provável?',
      opts:['Enurese','Encoprese','Transtorno de Oposição Desafiante','Transtorno do Espectro Autista'],
      correct:1,
      explicacao:'Eliminação repetida de fezes em locais inapropriados, mais de uma vez por mês há meses, em criança de seis anos e sem causa intestinal, caracteriza a Encoprese (DSM-5-TR); o fato de muitas vezes nem perceber que sujou aponta o subtipo involuntário e afasta a leitura de birra. Não há perda de urina, o que afasta a Enurese; não há hostilidade ou intenção de contrariar, o que afasta o Transtorno de Oposição Desafiante; e a criança interage e faz amizades normalmente, o que afasta o Espectro Autista.'
    },
    {
      id:'insonia', cat:'Transtornos do sono-vigília', nivel:'N2',
      ...
      vinheta:[
        'Mulher de 44 anos, analista administrativa, procura avaliação porque, desde uma reorganização na empresa no início de novembro, passa a maior parte das noites rolando na cama: leva mais de uma hora até adormecer, desperta três ou quatro vezes ao longo da madrugada e, quando acorda por volta das quatro horas, fica de olhos abertos sem conseguir voltar a pegar no sono até o despertador tocar. Mora sozinha, mantém o quarto escuro e silencioso, deita sempre por volta das vinte e duas e meia e dispõe de oito horas livres para descansar antes de sair para o trabalho; ainda assim, o quadro se repete em pelo menos quatro noites por semana e já se arrasta dos meses de fim de ano até agora, em junho.',
        'Durante o dia relata cansaço constante, pavio curto com os colegas e dificuldade para se concentrar nos relatórios, o que a faz refazer planilhas e perder prazos; em reuniões longas chega a bocejar, mas nunca cochila de fato nem sente um impulso incontrolável de dormir, e permanece de pé e firme mesmo quando ri ou se irrita. Nega uso de bebidas alcoólicas, café após o almoço, medicamentos para dormir ou ideação suicida, e descreve a própria angústia como centrada justamente nas horas perdidas tentando dormir, sem outras preocupações que a acompanhem ao longo do dia.'
      ],
      pergunta:'Dentre as alternativas, qual o diagnóstico mais provável?',
      opts:['Transtorno de Hipersonolência','Transtorno de Insônia','Narcolepsia','Transtorno de Ansiedade Generalizada'],
      correct:1,
      explicacao:'Dificuldade para iniciar e manter o sono e despertar precoce sem retorno, pelo menos quatro noites por semana, com prejuízo diurno (cansaço, irritabilidade, falhas de concentração) e duração superior a três meses (do fim do ano até junho), apesar de oportunidade adequada para dormir (quarto escuro, oito horas livres), define o Transtorno de Insônia (DSM-5-TR). Boceja mas nunca cochila nem tem impulso incontrolável de dormir, o que afasta a Hipersonolência; permanece firme mesmo ao rir ou se irritar, sem ataques de sono nem perda de tônus, o que afasta a Narcolepsia; e a angústia se restringe às horas perdidas de sono, sem preocupação difusa, o que afasta a Ansiedade Generalizada.'
    },
    {
      id:'narcolepsia', cat:'Transtornos do sono-vigília', nivel:'N2',
      ...
      vinheta:[
        'Homem de 22 anos, estudante universitário, é trazido à avaliação após uma sequência de episódios constrangedores e potencialmente perigosos: quase todos os dias, há vários meses, ele adormece de forma súbita e incontrolável em pleno meio de uma conversa, durante a aula e até atravessando a rua, sem conseguir resistir ao sono por mais que se esforce. Os cochilos vencem-no diversas vezes ao longo do dia, breves e involuntários, e ele desperta deles momentaneamente recuperado antes de a sonolência voltar a se acumular. Relata dormir o número habitual de horas à noite e acordar sem a sensação de descanso reposto pelo sono noturno; colegas de quarto que dividem o ambiente não notam roncos altos nem pausas em que ele pare de respirar enquanto dorme.',
        'Acompanham o quadro outros fenômenos que o assustam. Em situações em que ri alto de uma piada ou é pego de surpresa, sente subitamente as pernas bambearem e o pescoço ceder, com uma fraqueza passageira que o faz quase desabar no chão, embora permaneça lúcido o tempo todo; o evento dura segundos e se desfaz sozinho. Por vezes, no instante exato em que está pegando no sono, vê imagens vívidas como se já sonhasse e percebe que não consegue mover o corpo por alguns momentos. Nega uso de substâncias, álcool ou medicações que sedem, assim como qualquer ideação de morte; o humor, segundo ele, está preservado e ele mantém interesse pelos estudos e pelo convívio, frustrado apenas pelo descontrole sobre o próprio estado de vigília.'
      ],
      pergunta:'Dentre as alternativas, qual o diagnóstico mais provável?',
      opts:['Transtorno de Hipersonolência','Narcolepsia','Apneia e Hipopneia Obstrutivas do Sono','Transtorno Depressivo Maior'],
      correct:1,
      explicacao:'Ataques de sono irreprimíveis várias vezes ao dia, quase diariamente há meses, somados a episódios de fraqueza muscular súbita desencadeada por rir ou se surpreender (cataplexia), com alucinações ao adormecer e paralisia do sono, definem a Narcolepsia (DSM-5-TR). A cataplexia desencadeada por emoção é o discriminador; a ausência de ronco e de pausas respiratórias afasta a Apneia Obstrutiva; o humor e o interesse preservados afastam a Depressão; e a sonolência não se explica só por noites mal dormidas, o que afasta a Hipersonolência.'
    },
    {
      id:'ejaculacao', cat:'Disfunções sexuais', nivel:'N1',
      ...
      vinheta:[
        'Homem de 32 anos procura atendimento por uma queixa que o angustia e tem desgastado o relacionamento afetivo. Relata que, na maioria das relações sexuais, a ejaculação ocorre cerca de um minuto após a penetração vaginal, antes do que ele desejaria, com pouca sensação de controle sobre o momento em que ela acontece. Descreve que tenta adiar esse desfecho, mas raramente consegue, e que o desconforto e a frustração se repetem encontro após encontro, gerando tensão no casal e evitação gradual da intimidade.',
        'Esclarece que o desejo sexual permanece presente e que a ereção surge e se mantém sem dificuldade ao longo do ato. O padrão vem se mantendo de forma consistente há mais de seis meses, na maior parte das vezes em que há atividade sexual. Fora desse contexto, descreve humor estável, sono preservado e ausência de preocupações excessivas e generalizadas ao longo dos dias; nega uso de substâncias, medicações recentes ou ideação suicida. O incômodo se concentra especificamente na rapidez com que a relação se encerra.'
      ],
      pergunta:'Dentre as alternativas, qual o diagnóstico mais provável?',
      opts:['Transtorno Erétil','Ejaculação Prematura (Precoce)','Ejaculação Retardada','Transtorno de Ansiedade Generalizada'],
      correct:1,
      explicacao:'Ejaculação que ocorre cerca de um minuto após a penetração, antes do desejado, com pouco controle, na maioria das relações e há mais de seis meses, com sofrimento e impacto no casal, caracteriza a Ejaculação Prematura (Precoce) (DSM-5-TR). O desejo e a ereção estão preservados, o que afasta o Transtorno Erétil; o problema é a rapidez, não atraso ou ausência de ejaculação, o que afasta a Ejaculação Retardada; e o humor é estável, sem preocupações difusas, o que afasta a Ansiedade Generalizada.'
    },
    {
      id:'desejo_feminino', cat:'Disfunções sexuais', nivel:'N2',
      ...
      vinheta:[
        'Mulher de 38 anos, casada há doze anos, procura avaliação por iniciativa própria depois que o marido passou a comentar a frieza entre os dois. Relata que, desde o inverno do ano anterior, a vontade de iniciar ou aceitar aproximações do parceiro foi sumindo: não se lembra de quando teve pela última vez um pensamento erótico espontâneo, não sente atração ao ver o companheiro saindo do banho e, quando ele a toca, o corpo permanece como que desligado, sem o calor e a lubrificação de antes. Sustenta as tarefas de casa e o emprego de bibliotecária com a mesma dedicação, dorme bem, mantém o humor estável e continua rindo das séries que assistem juntos; nega uso de medicamentos novos, álcool em excesso ou ideias de morte.',
        'Conta que evita os momentos de cama não por receio do que sentirá, mas porque já sabe que nada se acende, e que isso a deixa triste e culpada, distante do marido que ainda a procura. Nas poucas vezes em que cede ao toque dele e a relação se completa, descreve que a penetração ocorre sem ardor, aperto ou qualquer desconforto físico, embora ela permaneça alheia do começo ao fim, sem aquele crescendo de envolvimento que reconhecia no início do casamento. O orgasmo, quando ela se esforça para chegar, até aparece, porém soa vazio, porque o problema, segundo ela, começa bem antes, na ausência de qualquer apetite ou resposta ao estímulo.'
      ],
      pergunta:'Dentre as alternativas, qual o diagnóstico mais provável?',
      ...
      correct:1,
      explicacao:'Redução persistente do interesse e da excitação sexual (sem fantasias espontâneas, sem atração, corpo sem resposta e sem lubrificação), por mais de seis meses e com sofrimento, define o Transtorno do Interesse/Excitação Sexual Feminino (DSM-5-TR). O orgasmo, quando ela se esforça, até aparece, e o problema começa antes, na falta de desejo, o que afasta o Transtorno do Orgasmo; a penetração ocorre sem ardor ou aperto, o que afasta a Dor Gênito-pélvica; e o humor, o sono e o prazer com outras coisas estão preservados, o que afasta a Depressão.'
    },
    {
      id:'conduta', cat:'Disruptivos, controle de impulsos e conduta', nivel:'N2',
      ...
      vinheta:[
        'Adolescente de 15 anos, do sexo masculino, encaminhado pela coordenação da escola após um ano marcado por uma sucessão de problemas sérios. No período, somou três suspensões: em duas delas partiu para cima de colegas menores, encurralou-os no pátio e os deixou com hematomas e um corte que precisou de curativo; na outra, foi pego saindo da loja de conveniência com mercadorias que não havia pago. Inventa versões diferentes para professores e para a família quando isso lhe rende dinheiro emprestado ou o livra de cobranças, e já arrombou armários alheios. Em uma noite recente, pichou e quebrou cadeiras e janelas do laboratório depois que a escola fechou. Os boletins de frequência mostram que, desde o início do ano letivo, acumulou faltas em mais de quarenta dias em que saiu de casa de manhã e nunca chegou ao colégio, além de duas noites em que dormiu fora sem avisar os pais. Nega uso de substâncias e qualquer ideia de se ferir.',
        'Os professores relatam que ele troca de assunto com facilidade durante as aulas, raramente entrega tarefas no prazo e perde material com frequência, queixas que também apareciam de forma branda nos anos anteriores, sem que houvesse, na época, registros de agressão, dano à propriedade ou afastamento das aulas. Em casa, contesta ordens e discute alto quando contrariado, mas os episódios de raiva surgem sempre após um plano frustrado, como ser impedido de sair à noite, e cedem assim que ele consegue o que pretendia. A mãe descreve um filho que, ao longo do último ano, passou a tratar limites e a propriedade dos outros como obstáculos a contornar, ferindo quem estiver no caminho. O rendimento escolar caiu, embora os professores observem que, quando lhe interessa, ele se concentra e conclui o que começou.'
      ],
      pergunta:'Dentre as alternativas, qual o diagnóstico mais provável?',
      ...
      correct:1,
      explicacao:'Padrão repetitivo e persistente, ao longo de mais de um ano, de violação dos direitos dos outros e de normas sociais importantes, abrangendo agressão a pessoas (encurralou e feriu colegas), destruição de propriedade (quebrou e pichou o laboratório), fraude ou furto (mentir para obter vantagem, arrombar armários, sair da loja sem pagar) e violações graves de regras (mais de quarenta faltas por gazeta, dormir fora sem avisar), caracteriza o Transtorno da Conduta (DSM-5-TR). Vai muito além de contestar ordens, o que afasta o Transtorno de Oposição Desafiante; a desatenção já existia branda antes, sem conduta antissocial, e ele se concentra quando lhe interessa, o que afasta o TDAH; e as explosões de raiva são instrumentais (cedem quando consegue o que quer), o que afasta o Explosivo Intermitente (surtos impulsivos sem propósito).'
    },
    {
      id:'explosivo', cat:'Disruptivos, controle de impulsos e conduta', nivel:'N3',
      ...
      vinheta:[
        'Homem de 28 anos, sem queixa de doença clínica atual, procura avaliação por orientação da empresa após um episódio no trabalho em que, ao receber uma correção sobre uma planilha, levantou-se em poucos segundos, gritou com o supervisor e arremessou o monitor contra a parede; ele descreve o quadro como algo que começa e termina muito rápido, em geral em menos de meia hora, e relata que essas reações vêm se repetindo três a quatro vezes por semana ao longo do último ano. Os relatos seguem um mesmo desenho: um carro que fecha o trânsito, uma fila que demora, um comentário do colega, e a resposta vem antes de qualquer pensamento, com gritos, portas batidas, copos e celulares quebrados, e em duas ocasiões empurrões que levaram a brigas físicas; passada a descarga, costuma chorar, ligar para pedir desculpas e pagar pelos estragos, dizendo que não reconhece quem age daquele jeito.',
        'Entre um episódio e outro, mantém emprego há seis anos no mesmo setor, paga as contas em dia, cumpre prazos e descreve relações estáveis com colegas e vizinhos, sem histórico de furtos, mentiras para obter vantagem, fugas ou crueldade deliberada; a intensidade das reações não guarda relação com o tamanho do que as desencadeia, e ele nega ter planejado qualquer uma delas ou ter tirado proveito do medo dos outros. Nos dias em que isso acontece, dorme e come como sempre, mantém o ritmo habitual de trabalho e de conversa, sem fases de vários dias seguidos com menos sono, gastos fora do comum, projetos novos em excesso ou aceleração no falar e no pensar; nega uso de álcool ou outras substâncias antes dos episódios e nega ideias de morte, e exames de rotina recentes não mostraram alterações.'
      ],
      pergunta:'Dentre as alternativas, qual o diagnóstico mais provável?',
      opts:['Transtorno da Conduta','Transtorno Explosivo Intermitente','Transtorno Bipolar Tipo I','Transtorno de Oposição Desafiante'],
      correct:1,
      explicacao:'Explosões comportamentais recorrentes que refletem falha em controlar impulsos agressivos, grosseiramente desproporcionais à provocação, em segundos e sem premeditação, várias vezes por semana ao longo de um ano e com remorso depois, caracterizam o Transtorno Explosivo Intermitente (DSM-5-TR). Fora dos episódios não há padrão amplo de violar direitos ou regras, e a agressão é impulsiva e reativa, não instrumental (afasta o Transtorno da Conduta); não há período de humor elevado com menos sono e mais projetos (afasta o Bipolar I); e o funcionamento interepisódico é preservado, com explosões graves e discretas em vez de oposição difusa, num adulto (afasta o Transtorno de Oposição Desafiante).'
    },
    {
      id:'alcool', cat:'Substâncias e transtornos aditivos', nivel:'N1',
      ...
      vinheta:[
        'Homem de 45 anos, levado ao serviço pela esposa, que se diz preocupada com a quantidade de bebida que ele consome em casa. Ao longo dos últimos anos, relata que precisou aumentar progressivamente a dose para alcançar o mesmo efeito que antes obtinha com bem menos; já tentou cortar por conta própria em várias ocasiões ao longo do último ano, sem conseguir manter a redução por mais que poucos dias. Quando fica algumas horas sem consumir, surgem tremores nas mãos e sudorese que cedem assim que ele volta a ingerir a substância, e descreve um desejo intenso e difícil de ignorar nesses intervalos. Nega ideação suicida e nega febre ou uso de outras substâncias.',
        'Nos últimos doze meses, o padrão trouxe consequências concretas: faltou ao trabalho em manhãs seguidas a episódios de consumo pesado, teve discussões frequentes com a esposa pelo mesmo motivo e se envolveu em uma batida de carro a caminho de casa. Mesmo descrevendo esses prejuízos e dizendo entendê-los, mantém o consumo no mesmo ritmo. Refere humor abatido em alguns dias, sobretudo após as brigas, mas o abatimento aparece e some conforme os episódios de consumo e das discussões, sem perdurar de forma autônoma, e o eixo de suas queixas é a própria dificuldade de controlar o quanto bebe.'
      ],
      pergunta:'Dentre as alternativas, qual o diagnóstico mais provável?',
      ...
      correct:1,
      explicacao:'Padrão problemático de uso de álcool ao longo de doze meses com tolerância (aumentou a dose para o mesmo efeito), abstinência (tremores e sudorese que cedem ao reingerir), fissura, tentativas frustradas de reduzir e uso continuado apesar de prejuízos (faltas, brigas, batida de carro), caracteriza o Transtorno por Uso de Álcool (DSM-5-TR). A abstinência com tremores e sudorese revertida pela dose é típica do álcool, não de estimulantes (cuja retirada cursa com fadiga e hipersonia) nem de opioides (rinorreia, lacrimejamento, dores); e o humor abatido é secundário e flutuante, sem episódio depressivo sustentado, o que afasta a Depressão.'
    },
    {
      id:'opioides', cat:'Substâncias e transtornos aditivos', nivel:'N2',
      ...
      vinheta:[
        'Homem de 34 anos, montador industrial, em acompanhamento ambulatorial há cerca de um ano após uma cirurgia de coluna, durante a qual recebeu analgésicos potentes para a dor. Concluído o período previsto de recuperação, manteve o consumo desses comprimidos e, ao longo dos meses, foi precisando de quantidades cada vez maiores para obter o mesmo alívio que antes alcançava com poucas unidades. Passou a frequentar diferentes consultórios e prontos-socorros relatando dores, de modo a renovar receitas, e em ao menos duas ocasiões adquiriu os comprimidos fora de farmácias, sem prescrição. Reduziu plantões, acumulou faltas e teve desentendimentos frequentes com a esposa, que percebeu a rotina cada vez mais organizada em torno de conseguir e tomar a medicação, embora ele siga consumindo apesar dessas perdas.',
        'Nas tentativas de interromper por conta própria, geralmente em fins de semana, surgem em poucas horas dores difusas pelo corpo, inquietação, suor, lacrimejamento e mal-estar acentuado, que cedem quando volta a tomar os comprimidos; foi justamente esse desconforto, descrito como insuportável, que frustrou as últimas tentativas. Refere ainda episódios de tensão e preocupação, porém estes se concentram nas horas que antecedem o reinício do quadro físico e se dissipam após a primeira dose do dia. Bebe socialmente nos finais de semana, sem aumento ao longo do tempo, e não faz uso de comprimidos para dormir ou acalmar fora os já citados. Nega ideação suicida, febre e uso de outras substâncias; o sono e o apetite oscilam conforme os dias em que está ou não em uso.'
      ],
      pergunta:'Dentre as alternativas, qual o diagnóstico mais provável?',
      ...
      correct:1,
      explicacao:'Padrão problemático de uso de opioides ao longo de doze meses com tolerância (doses crescentes), abstinência característica (dores difusas, inquietação, suor, lacrimejamento que cedem ao retomar), esforço para obter a substância (vários médicos e compra fora) e uso continuado apesar de prejuízo ocupacional e familiar, define o Transtorno por Uso de Opioides (DSM-5-TR). A substância é o opioide: bebe socialmente sem aumento (afasta o Uso de Álcool) e não usa comprimidos para dormir ou acalmar (afasta o Uso de Sedativos); e a tensão se concentra antes da dose e some depois, sendo ansiedade da abstinência, não um transtorno independente (afasta a Ansiedade Generalizada).'
    },
    {
      id:'disforia_adulto', cat:'Disforia de gênero', nivel:'N2',
      ...
      vinheta:[
        'Mulher de 26 anos, designada do sexo masculino ao nascer, procura atendimento por angústia que descreve como antiga, presente desde os primeiros anos de escola, quando já evitava as roupas e as brincadeiras que lhe eram impostas e se sentia em desacordo com o corpo que via no espelho. Relata um sentimento contínuo de que o gênero que lhe foi atribuído nunca correspondeu a quem ela é, e que esse descompasso entre o que vivencia e o que foi designado se mantém firme e diário desde muito antes do último ano, manifestando-se em um desejo forte de alterar características corporais e de ser reconhecida e tratada conforme a sua identidade. Quando precisa usar o nome de registro ou é vista pelos colegas como homem, descreve aperto no peito e vontade de se isolar.',
        'Nos atendimentos, esclarece que o desconforto não gira em torno de um defeito ou imperfeição específica na aparência que considere feia, e sim da incongruência com o próprio corpo sexuado; passa o dia conferindo o espelho apenas para avaliar o quanto sua silhueta a aproxima ou afasta de como deseja ser vista. Usa roupas femininas de maneira constante e como parte de viver segundo a sua identidade, sem que isso lhe traga qualquer carga de excitação. O quadro compromete o convívio com a família e o desempenho no trabalho, onde tem faltado em dias de reuniões presenciais. Nega uso de substâncias e ideação suicida; o sono e o apetite estão preservados.'
      ],
      pergunta:'Dentre as alternativas, qual o diagnóstico mais provável?',
      opts:['Outra Disforia de Gênero Especificada','Disforia de Gênero','Transtorno Dismórfico Corporal','Transtorno Transvéstico'],
      correct:1,
      explicacao:'Incongruência acentuada e persistente entre o gênero vivenciado e o designado, desde a infância e mantida muito além de seis meses, com forte desejo de modificar características corporais e de ser reconhecida conforme a identidade, e sofrimento com prejuízo social e ocupacional, define a Disforia de Gênero (DSM-5-TR). Por preencher todos os critérios, não é Outra Disforia de Gênero Especificada (reservada a quadros incompletos); o desconforto é com o corpo sexuado, não com um defeito estético percebido (afasta o Dismórfico); e usar roupas femininas é parte de viver na identidade, sem carga de excitação, o que afasta o Transtorno Transvéstico.'
    },
    {
      id:'disforia_crianca', cat:'Disforia de gênero', nivel:'N2',
      ...
      vinheta:[
        'Criança de 8 anos, designada do sexo masculino ao nascer, levada pelos pais a consulta de orientação porque, desde os primeiros anos de vida, afirma de modo constante e enfático pertencer ao gênero feminino. Aos 3 anos passou a recusar cortes de cabelo curtos e a pedir os mesmos modelos de roupa das colegas; na escola, hoje no terceiro ano, escolhe sempre as brincadeiras, os personagens e os brinquedos que as outras meninas elegem e abandona a mesa quando os colegas montam jogos de luta ou de carrinhos. Os pais relatam que essa preferência se mantém inalterada desde o segundo ano de vida, sem qualquer período de oscilação, e que a criança demonstra incômodo crescente com os próprios genitais e com a expectativa de que o corpo se desenvolva como o de um menino na puberdade.',
        'Em casa, mostra-se carinhosa e cooperativa nas tarefas combinadas e não apresenta padrão de desafio a regras ou de irritabilidade dirigida a adultos; os episódios de choro e angústia concentram-se nas ocasiões em que é chamada pelo nome de registro ou apresentada a parentes como menino, situações em que se isola e verbaliza tristeza profunda. Os pais negam uso de substâncias, ideação suicida ou febre recente. Não há queixa sobre um aspecto específico do rosto ou do corpo julgado feio ou defeituoso, nem comportamentos repetidos de checagem diante do espelho; o sofrimento descrito surge sempre ligado à forma como a criança é tratada quanto ao gênero, e não a uma falha estética percebida.'
      ],
      pergunta:'Dentre as alternativas, qual o diagnóstico mais provável?',
      ...
      correct:0,
      explicacao:'Em criança, incongruência marcante e persistente entre o gênero experimentado e o designado, mantida por anos (desde os 2 anos, agora aos 8), com forte desejo de pertencer ao gênero feminino, preferências e companhias correspondentes, desconforto com as próprias características sexuais e, decisivamente, sofrimento clínico (choro, isolamento, tristeza quando tratada de forma incongruente), define a Disforia de Gênero (DSM-5-TR). Como há incongruência persistente e sofrimento, não é a categoria residual Outra Disforia Especificada; o desconforto é com o corpo sexuado, não com um defeito estético (afasta o Dismórfico); e a criança é carinhosa e cooperativa, sem padrão opositor (afasta o Transtorno de Oposição Desafiante).'
    },
    {
      id:'alzheimer', cat:'Transtornos neurocognitivos', nivel:'N3',
      ...
      vinheta:[
        'Mulher de 74 anos, aposentada, levada ao ambulatório pela filha. O quadro começou por volta de 2021, quando passou a repetir as mesmas perguntas na mesma tarde e a anotar recados em papéis que depois não encontrava. Ao longo de 2022 e 2023 errou por duas vezes o caminho de volta da padaria do bairro e pagou boletos já quitados em duplicidade; no último ano deixou de administrar a própria medicação, hoje separada pela filha, e abandonou o trabalho de costura que praticava havia décadas. A filha descreve um declínio lento e contínuo desde 2021, com a mesma intensidade de perda mês a mês, e refere que nas últimas duas semanas o quadro seguiu igual, sem febre, queda ou início de remédio novo.',
        'É hipertensa em uso de losartana, com TSH e vitamina B12 dentro da faixa e tomografia de crânio com atrofia cortical difusa, sem área de lesão isquêmica delimitada. Durante a avaliação o nível de alerta mantém-se estável, conserva o foco e segue as instruções sem se perder, mas está desorientada quanto a tempo e lugar; não recorda nenhuma de três palavras após cinco minutos, mesmo com a pista da categoria, e falha em copiar a figura dos pentágonos, com discurso entremeado de circunlóquios. O humor é eutímico e o afeto reativo, sorri ao recordar a costura, e o sono e o apetite estão preservados.'
      ],
      pergunta:'Dentre as alternativas, qual o diagnóstico mais provável?',
      ...
      correct:1,
      explicacao:'Declínio cognitivo adquirido em múltiplos domínios (memória de evocação 0/3 que não melhora com pista, função executiva, visuoconstrução, linguagem com circunlóquios) com perda de autonomia (medicação separada pela filha, erros de trajeto e de contas), de início insidioso em 2021 e curso lento e contínuo, com consciência e atenção preservadas, aponta para Transtorno Neurocognitivo Maior devido à Doença de Alzheimer (DSM-5-TR). O nível de alerta estável, sem flutuação nem fator agudo, afasta o Delirium; o curso contínuo (não em degraus) e a TC com atrofia difusa sem lesão isquêmica afastam o quadro vascular (a hipertensão é só fator de risco); e o humor eutímico com a pista ineficaz afastam a pseudodemência depressiva.'
    },
    {
      id:'delirium', cat:'Transtornos neurocognitivos', nivel:'N3',
      ...
      vinheta:[
        'Homem de 78 anos, previamente independente nas atividades diárias e descrito pela família como lúcido e bom de raciocínio até a véspera, encontra-se internado em enfermaria desde a manhã anterior por um quadro de infecção do trato urinário confirmado em exame. Ao longo do segundo dia de internação, a equipe registra que, por volta das oito horas, ele aparecia sonolento, sem identificar o hospital nem o motivo da internação, chamando a esposa pelo nome de uma vizinha; já no início da tarde, encontrava-se mais desperto e falante, embora interrompesse cada frase no meio e não conseguisse repetir uma sequência simples de números nem seguir uma ordem de duas etapas, perdendo o fio a cada estímulo do corredor.',
        'Pela noite, voltou a ficar agitado, tentando retirar o acesso venoso e descendo da cama sem perceber o risco, para de manhã seguinte estar de novo quieto e pouco responsivo; a própria equipe de enfermagem anota que o estado dele muda de hora em hora, sem padrão fixo. O filho, ao telefone, confirma que até dois dias antes o pai dirigia, pagava as próprias contas e não tinha qualquer esquecimento que se arrastasse de mês a mês ou de ano a ano, e que nada parecido jamais ocorrera; nega febre alta no momento, uso de bebida alcoólica e ideação de morte. A instalação de todo o quadro coincidiu, em poucas horas, com o agravamento da infecção.'
      ],
      pergunta:'Dentre as alternativas, qual o diagnóstico mais provável?',
      ...
      correct:1,
      explicacao:'Perturbação aguda da atenção e da consciência, instalada em poucas horas, que flutua de hora em hora ao longo do dia e coincide com o agravamento de uma infecção urinária, caracteriza o Delirium (DSM-5-TR). A flutuação e o início agudo sobre uma base previamente lúcida (dirigia e pagava contas até dois dias antes) afastam o declínio insidioso e progressivo do Transtorno Neurocognitivo por Alzheimer e o curso em degraus do Vascular; e a confusão decorre do rebaixamento e da oscilação do nível de consciência ligados à causa clínica, não de sintomas psicóticos primários em sensório claro, o que afasta o Transtorno Psicótico Breve.'
    },
    {
      id:'borderline', cat:'Transtornos da personalidade', nivel:'N3',
      ...
      vinheta:[
        'Mulher de 25 anos procura atendimento logo após o término abrupto de mais um relacionamento, descrevendo um roteiro que se repete desde que saiu da adolescência: vínculos que começam arrebatadores, com o parceiro tratado como a melhor pessoa que já conheceu, e que poucas semanas depois se transformam em desprezo intenso quando ela percebe qualquer falha. Cada sinal de que pode ser deixada, uma mensagem não respondida, um plano cancelado, dispara nela uma agitação quase insuportável, e já chegou a aparecer sem aviso na casa de ex-parceiros, ligar dezenas de vezes seguidas e prometer mudanças drásticas para evitar a separação. Entre um relacionamento e outro, relata não saber direito quem é nem o que quer da vida, trocando de planos, cursos e até de modo de se vestir conforme a companhia do momento, e queixa-se de uma sensação persistente de não ter nada por dentro, como se fosse oca.',
        'Esse jeito de funcionar, segundo ela, é o mesmo há anos e atravessa praticamente tudo, o trabalho, as amizades, a família e a forma como se enxerga, sem que haja períodos delimitados de dias ou semanas em que ela tenha se sentido continuamente acelerada, com menos necessidade de sono e mais produtiva que o habitual, ou inversamente travada e lentificada por um bloco de tempo definido; as viradas de seu estado ocorrem em horas, geralmente ancoradas a algo que aconteceu no contato com as pessoas. Nos momentos de maior angústia, costuma gastar quantias que comprometem suas contas e fazer pequenos cortes nos antebraços, que mostra com naturalidade, dizendo que a dor a faz voltar a si. Nega uso de substâncias e nega intenção atual de tirar a própria vida, embora reconheça que já teve esse pensamento em crises anteriores.'
      ],
      pergunta:'Dentre as alternativas, qual o diagnóstico mais provável?',
      ...
      correct:1,
      explicacao:'Padrão difuso e persistente, desde o início da vida adulta, de instabilidade nas relações (idealização e desvalorização), esforços desesperados para evitar abandono, perturbação de identidade, vazio crônico, impulsividade autolesiva (gastos e cortes) e instabilidade afetiva reativa, caracteriza o Transtorno da Personalidade Borderline (DSM-5-TR). Não há períodos delimitados de dias ou semanas de humor elevado ou deprimido, e as viradas duram horas e são reativas, o que afasta o Bipolar II; o núcleo é o medo de abandono e o vazio, não a busca de ser o centro das atenções (afasta a Histriônica) nem a grandiosidade (afasta a Narcisista).'
    },
    {
      id:'antissocial', cat:'Transtornos da personalidade', nivel:'N3',
      ...
      vinheta:[
        'Homem de 30 anos, encaminhado para avaliação a pedido de um serviço de acompanhamento, acumula registros de passagens pela justiça que começaram quando tinha 15 anos, sempre por situações semelhantes: bens alheios que somem, assinaturas e documentos forjados, brigas em que termina ferindo quem estava por perto. Constrói versões convincentes para conseguir dinheiro ou favores e, quando descoberto, monta outra história sem alterar a expressão ou o ritmo da fala; nas entrevistas relata os episódios como fatos corriqueiros e atribui o resultado a quem, segundo ele, se colocou no caminho ou mereceu o que aconteceu.',
        'Os vínculos de trabalho duram poucas semanas e os compromissos assumidos raramente são cumpridos, sem que isso o incomode ou o leve a mudar de conduta. As decisões que o colocam em apuros costumam ser tomadas no momento, sem qualquer plano que as anteceda, e o prejuízo causado a terceiros não aparece em nenhum momento do relato como algo que pesa. Nega uso de bebida ou outras substâncias no período dos fatos e nega ideias de morte; o exame não identifica alteração do humor nem oscilações que tenham acompanhado essa trajetória, que se manteve com o mesmo feitio ao longo de toda a vida adulta.'
      ],
      pergunta:'Dentre as alternativas, qual o diagnóstico mais provável?',
      ...
      correct:1,
      explicacao:'Padrão difuso de desrespeito e violação dos direitos alheios (furtos, fraudes, agressões, mentiras manipulativas), iniciado aos 15 anos e mantido na vida adulta em pessoa de 30 anos, com impulsividade, irresponsabilidade no trabalho e ausência de remorso (culpa as vítimas), caracteriza o Transtorno da Personalidade Antissocial (DSM-5-TR). Avaliado já adulto, com a trajetória mantida por toda a vida adulta, o quadro é Antissocial e não Transtorno da Conduta (diagnóstico antes dos 18 anos); não há grandiosidade ou busca de admiração (afasta a Narcisista); e o padrão independe de intoxicação, sem alteração de humor, o que afasta o Uso de Álcool.'
    },
    {
      id:'voyeurista', cat:'Transtornos parafílicos', nivel:'N2',
      ...
      vinheta:[
        'Homem de 29 anos, encaminhado para avaliação por familiares após ser flagrado por vizinhos enquanto, parado de modo discreto junto a uma janela mal iluminada do prédio, mantinha o olhar fixo no apartamento em frente, onde um casal vivia um momento de intimidade sem perceber que estava sendo visto. Em entrevista, relata que, desde o início do verão de 2025, escolhe horários e pontos do edifício de onde consegue acompanhar moradores que trocam de roupa ou ficam nus com as cortinas abertas, e descreve uma intensa excitação ligada justamente ao fato de que essas pessoas não sabem da presença dele; a avaliação ocorre em fevereiro de 2026. Admite ter repetido a prática diversas vezes ao longo desse período e que, em algumas ocasiões, chegou a se aproximar de áreas comuns do condomínio para conseguir um ângulo melhor.',
        'Conta que evita qualquer contato direto e nunca abordou fisicamente os moradores, preferindo permanecer à distância e fora do campo de visão deles. Refere vergonha e arrependimento depois dos episódios, episódios de insônia e preocupação constante de ser descoberto, e menciona que uma denúncia recente o expôs a possíveis consequências legais e quase custou o emprego, embora afirme ter dificuldade de interromper a conduta mesmo ciente desses riscos. Tem histórico escolar e profissional regular, mantém amizades e cumpre compromissos cotidianos sem queixas de terceiros nesses âmbitos; nega uso de substâncias, ideação suicida e febre, e não há relato de outras infrações ou de padrão de desrespeito a regras e a direitos alheios fora dessas situações.'
      ],
      pergunta:'Dentre as alternativas, qual o diagnóstico mais provável?',
      opts:['Transtorno Exibicionista','Transtorno Voyeurista','Transtorno Frotteurista','Transtorno da Personalidade Antissocial'],
      correct:1,
      explicacao:'Excitação sexual recorrente e intensa derivada de observar pessoas desavisadas, nuas ou em atividade sexual, ligada ao fato de elas não saberem que estão sendo vistas, por mais de seis meses (do verão de 2025 a fevereiro de 2026) e com o sujeito tendo agido sobre o impulso, com sofrimento e risco legal, caracteriza o Transtorno Voyeurista (DSM-5-TR). Não há exposição dos próprios genitais (afasta o Exibicionista) nem toque ou fricção, já que evita contato e permanece à distância (afasta o Frotteurista); e o funcionamento social e profissional é regular, sem padrão amplo de transgressão, o que afasta a Personalidade Antissocial.'
    },
    {
      id:'fetichista', cat:'Transtornos parafílicos', nivel:'N2',
      ...
      vinheta:[
        'Homem de 35 anos, casado, procura atendimento bastante envergonhado por um padrão que o incomoda há anos e que evita comentar com qualquer pessoa. Relata que, para alcançar e manter a excitação sexual, precisa de um tipo específico de calçado de couro feminino, que toca e segura durante a relação; na ausência desse objeto, sente-se sexualmente bloqueado e mal consegue dar continuidade ao ato. Esse funcionamento se repete em praticamente todos os encontros e já vinha assim quando ele e a esposa se mudaram para a casa atual, há cerca de dois anos, sem janelas de melhora desde então. A parceira passou a se sentir preterida e o procura cada vez menos, o que ele descreve com angústia e culpa.',
        'O próprio paciente não veste as peças nem se interessa por usar roupas que não as suas; o que o atrai é a textura, o cheiro e o manuseio do calçado em si, mantido ao alcance da mão durante o sexo. Nega que a excitação envolva ser dominado, machucado ou exposto a situações humilhantes, e diz que o contato com o objeto é vivido como prazeroso e desejado, sem qualquer impulso de afastá-lo da mente. Nega uso de substâncias, ideação suicida e outras queixas clínicas. Refere que tentou abandonar o hábito a pedido da esposa, mas a tentativa apenas reduziu a frequência sexual do casal e ampliou o desconforto entre eles.'
      ],
      pergunta:'Dentre as alternativas, qual o diagnóstico mais provável?',
      opts:['Transtorno Transvéstico','Transtorno Fetichista','Transtorno do Masoquismo Sexual','Transtorno Obsessivo-Compulsivo'],
      correct:1,
      explicacao:'Excitação sexual recorrente e intensa que depende de um objeto inanimado específico (calçado de couro feminino), cuja textura, cheiro e manuseio são o foco do prazer, com bloqueio na sua ausência, por mais de seis meses (há cerca de dois anos) e com sofrimento e prejuízo conjugal, caracteriza o Transtorno Fetichista (DSM-5-TR). Ele não veste as peças nem se interessa por se travestir, o que afasta o Transtorno Transvéstico; a excitação não envolve ser humilhado ou submetido a dor, o que afasta o Masoquismo Sexual; e o contato com o objeto é vivido como prazeroso e desejado, sem impulso de afastá-lo da mente, sendo egossintônico, o que afasta o TOC.'
    }
  ];
  ...
  function topbar(){
    ...
    var lv = levelInfo(userXP());
    var levelPill = '<button id="xp-pill" data-action="goRanking" title="Ver ranking" data-hover="border-color:#5BC0BE;" style="display:flex;align-items:center;gap:7px;background:var(--surface);border:1px solid var(--border);border-radius:99px;padding:6px 13px 6px 7px;cursor:pointer;transition:border-color .18s ease;flex-shrink:0;">'+
    ...
    '<header class="topbar">'+
      ...
      '<div class="topbar-center">'+
        '<div class="topbar-search" style="position:relative;display:flex;align-items:center;gap:10px;background:var(--surface);border:1px solid var(--border);border-radius:12px;padding:9px 14px;width:100%;max-width:420px;">'+
          ICON.search+
  ...
  // ----- modo dev: validar os estudos de caso (sem randomizar) -----
  function isReworked(c){ return !!c.nivel; }   // caso já reescrito (tem nível N1-N4)
  function screenDevCasos(){
    if(!state.devMode) return screenHome();
    var filt = state.devCasosFilter || 'todos';
    var nRew = CASOS.filter(isReworked).length;
    function tab(label, v){ return '<button data-action="setDevCasosFilter" data-arg="'+v+'" class="rev-tab'+(filt===v?' on':'')+'">'+label+'</button>'; }
    var rows = CASOS.map(function(c,i){ return {c:c,i:i}; })
      .filter(function(o){ return filt==='todos' || isReworked(o.c); })
      .map(function(o){
        var c=o.c, i=o.i, rew=isReworked(c);
        var correta = (c.opts && c.opts[c.correct]) || '—';
        return '<div data-action="openCasoAt" data-arg="'+i+'" data-hover="border-color:#8338EC;" style="cursor:pointer;display:flex;align-items:center;gap:12px;border:1px solid var(--border);background:var(--surface);border-radius:12px;padding:11px 14px;transition:border-color .15s ease;">'+
          '<span style="flex-shrink:0;width:30px;height:30px;border-radius:8px;background:var(--surface-2);display:flex;align-items:center;justify-content:center;font:800 13px \'Bricolage Grotesque\';color:var(--muted-2);">'+(i+1)+'</span>'+
          '<div style="flex:1;min-width:0;">'+
            '<div style="display:flex;align-items:center;gap:8px;flex-wrap:wrap;"><span style="font-weight:700;font-size:14px;color:var(--ink);">'+esc(correta)+'</span>'+(rew?'<span style="font-size:10px;font-weight:800;letter-spacing:.4px;text-transform:uppercase;color:#fff;background:#8338EC;border-radius:5px;padding:2px 6px;">'+esc(c.nivel)+'</span>':'')+'</div>'+
            '<div style="font-size:11.5px;color:var(--muted);white-space:nowrap;overflow:hidden;text-overflow:ellipsis;">'+esc(c.cat||'')+' · '+esc(c.id||'')+'</div>'+
          '</div>'+
    ...
    '<section style="max-width:760px;margin:0 auto;animation:rise .5s cubic-bezier(.2,.7,.3,1) both;">'+
      '<div style="display:flex;align-items:center;gap:10px;margin-bottom:8px;flex-wrap:wrap;">'+
        '<span style="font:800 10.5px \'Hanken Grotesk\';text-transform:uppercase;letter-spacing:.6px;color:#fff;background:#0E4D64;border-radius:7px;padding:4px 9px;">DEV</span>'+
        '<h1 style="font:800 28px \'Bricolage Grotesque\';letter-spacing:-.5px;margin:0;">Casos</h1>'+
      '</div>'+
      '<p style="margin:0 0 14px;color:var(--muted-2);font-size:15px;max-width:600px;">Abre cada caso na ordem fixa (sem randomizar) para validação. '+CASOS.length+' casos, '+nRew+' reescritos (com nível N1–N4). A resposta correta aparece no rótulo.</p>'+
      '<div class="rev-toggle" style="margin-bottom:14px;">'+tab('Todos','todos')+tab('Só reescritos','prontuario')+'</div>'+
