  ...
  var CASOS = [
    ...
    },
    {
      ...
      vinheta:[
        ...
        'Conta que é assaltada por pensamentos intrusivos e repetitivos de contaminação (imagens de germes, sujeira invisível, doença) que surgem contra a sua vontade e disparam uma ansiedade quase insuportável. Para aliviá-los, lava as mãos numa sequência rígida e repetida e cumpre rituais de limpeza que, somados, tomam mais de três horas do seu dia. Sabe que é exagerado e sente vergonha disso, mas diz que, “se não fizer, a aflição não passa”. As mãos estão rachadas e avermelhadas de tanto sabão; ela evita maçanetas e transporte público e tem chegado atrasada às aulas por causa dos rituais matinais. Não descreve crises súbitas de pânico nem um medo restrito a um único objeto ou situação específica, e o que a aflige não é uma preocupação difusa com o dia a dia, mas a dupla de sempre: o pensamento intrusivo seguido do ritual que alivia. O desempenho na faculdade e a convivência com as colegas de república já estão prejudicados.'
      ],
      pergunta:'Qual a hipótese diagnóstica mais provável?',
